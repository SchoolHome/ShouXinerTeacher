...
- (void)reloadData
{
    ...
    for (int i = 0; i<self.messages.count; i++) {
        ...
        {
            CGFloat mutilViewOwnHeight = 230+(tempArray.count-1)*40;
